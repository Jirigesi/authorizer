                   ...
                   SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(net.tjado.passwdsafe.R.layout.activity_launcher_record_shortcuts);
        SharedPreferences prefs = Preferences.getSharedPrefs(this);
        prefs.registerOnSharedPreferenceChangeListener(this);

        itsFile = (TextView)findViewById(net.tjado.passwdsafe.R.id.file);
        itsFileDataView.onAttach(this, prefs);

        Intent intent = getIntent();
        switch (intent.getAction()) {
        case Intent.ACTION_CREATE_SHORTCUT: {
            setTitle(net.tjado.passwdsafe.R.string.shortcut_record);
            itsMode = Mode.SHORTCUT;
            break;
        }
        case PasswdSafeApp.CHOOSE_RECORD_INTENT: {
            setTitle(net.tjado.passwdsafe.R.string.choose_record);
        ...
        if (savedInstanceState == null) {
            ...
            txn.replace(net.tjado.passwdsafe.R.id.contents,
    ...
    public void onResume()
    {
        ...
        if (fileTitleVal != null) {
            ...
            itsFile.setText(net.tjado.passwdsafe.R.string.no_records_open_file);
            GuiUtils.setVisible(findViewById(net.tjado.passwdsafe.R.id.contents), false);
        }
    }
    ...
    public void updateViewList(PasswdLocation location)
    {
        ...
        FragmentManager fragMgr = getSupportFragmentManager();
        Fragment contentsFrag = fragMgr.findFragmentById(net.tjado.passwdsafe.R.id.contents);
