...
public class UsbHidKbd_AppleMac_de_DE extends UsbHidKbd {

    public UsbHidKbd_AppleMac_de_DE() {
        ...
        kbdVal.put("y",					new byte[] {0x00, 0x00, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: z
        kbdVal.put("z",					new byte[] {0x00, 0x00, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: y
        ...
        kbdVal.put("Y",					new byte[] {0x02, 0x00, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: Z
        kbdVal.put("Z",					new byte[] {0x02, 0x00, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: Y
        ...
        kbdVal.put("@",					new byte[] {0x40, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00} ); // apple specific
        kbdVal.put("#",					new byte[] {0x00, 0x00, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: \
        kbdVal.put("$",					new byte[] {0x02, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("%",					new byte[] {0x02, 0x00, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("^",					new byte[] {0x00, 0x00, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: ~
        kbdVal.put("&",					new byte[] {0x02, 0x00, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: ^
        kbdVal.put("*",					new byte[] {0x02, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: }
        kbdVal.put("(",					new byte[] {0x02, 0x00, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: *
        kbdVal.put(")",					new byte[] {0x02, 0x00, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: (
        ...
        kbdVal.put("-",					new byte[] {0x00, 0x00, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: /
        kbdVal.put("=",					new byte[] {0x02, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: )
        kbdVal.put("[",					new byte[] {0x40, 0x00, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00} ); // apple specific
        kbdVal.put("]",					new byte[] {0x40, 0x00, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00} ); // apple specific
        kbdVal.put("\\",				new byte[] {0x42, 0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put(";",					new byte[] {0x02, 0x00, 0x36, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: >
        kbdVal.put("'",					new byte[] {0x02, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("`",					new byte[] {0x02, 0x00, 0x2e, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: +
        kbdVal.put(",",					new byte[] {0x00, 0x00, 0x36, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put(".",					new byte[] {0x00, 0x00, 0x37, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("/",					new byte[] {0x02, 0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: &

        kbdVal.put("_",					new byte[] {0x02, 0x00, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: ?
        kbdVal.put("+",					new byte[] {0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: ]
        kbdVal.put("{",					new byte[] {0x40, 0x00, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("}",					new byte[] {0x40, 0x00, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("|",					new byte[] {0x40, 0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put(":",					new byte[] {0x02, 0x00, 0x37, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: >
        kbdVal.put("\"",				new byte[] {0x02, 0x00, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00} );// english: @
        kbdVal.put("~",					new byte[] {0x40, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("<",					new byte[] {0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put(">",					new byte[] {0x02, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("?",					new byte[] {0x02, 0x00, 0x2d, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: _


        // german characters
        kbdVal.put("ß",					new byte[] {0x00, 0x00, 0x2d, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: -
        kbdVal.put("€",					new byte[] {0x40, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("°",					new byte[] {0x02, 0x00, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        //kbdVal.put("²",					new byte[] {0x40, 0x00, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00} ); // apple specific - not available
        //kbdVal.put("³",					new byte[] {0x40, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00} ); // apple specific - not available
        kbdVal.put("µ",					new byte[] {0x40, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific
        kbdVal.put("§",					new byte[] {0x02, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00} ); // german specific

        kbdVal.put("ä",					new byte[] {0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: '
        kbdVal.put("ö",					new byte[] {0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: ;
        kbdVal.put("ü",					new byte[] {0x00, 0x00, 0x2f, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: [

        kbdVal.put("Ä",					new byte[] {0x02, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: "
        kbdVal.put("Ö",					new byte[] {0x02, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: :
        kbdVal.put("Ü",					new byte[] {0x02, 0x00, 0x2f, 0x00, 0x00, 0x00, 0x00, 0x00} ); // english: {
