    ...
    implements OnCreateContextMenuListener, OnMenuItemClickListener
{
    ...
    {
        View row = findViewById(net2.tjado.passwdsafe.R.id.policy_view_location_row);
        row.setVisibility((location == null) ? View.GONE : View.VISIBLE);

        if (location != null) {
            TextView tv = (TextView)findViewById(net2.tjado.passwdsafe.R.id.policy_view_location);
            tv.setText(location);
        }
    }
    ...
    public void showPolicy(PasswdPolicy policy, int useCount)
    {
        ...
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_length, net2.tjado.passwdsafe.R.id.policy_view_length_label,
                   Integer.toString(length), true);
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_type, net2.tjado.passwdsafe.R.id.policy_view_type_label,
                   PasswdPolicy.getTypeStr(type, getContext()), true);
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_lowercase, net2.tjado.passwdsafe.R.id.policy_view_lowercase_label,
                   lowercase, optionsVisible);
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_uppercase, net2.tjado.passwdsafe.R.id.policy_view_uppercase_label,
                   uppercase, optionsVisible);
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_digits, net2.tjado.passwdsafe.R.id.policy_view_digits_label,
                   digits, optionsVisible);
        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_symbols, net2.tjado.passwdsafe.R.id.policy_view_symbols_label,
                   symbols, optionsVisible);

        setTextStr(net2.tjado.passwdsafe.R.id.policy_view_use_count, net2.tjado.passwdsafe.R.id.policy_view_use_count_label,
    ...
    {
        View row = findViewById(net2.tjado.passwdsafe.R.id.policy_view_generate_row);
                                    ...
                                    ContextMenuInfo menuInfo)
    {
        if (v == itsGeneratedPasswd) {
            menu.setHeaderTitle(net2.tjado.passwdsafe.R.string.password);
            menu.add(0, MENU_COPY, 0, net2.tjado.passwdsafe.R.string.copy_clipboard).
    ...
    {
        inflate(context, net2.tjado.passwdsafe.R.layout.passwd_policy_view, this);
        if (isInEditMode()) {
            return;
        }
        ...
        Button btn = (Button)findViewById(net2.tjado.passwdsafe.R.id.policy_view_generate);
        ...
        itsGeneratedPasswd =
            (TextView)findViewById(net2.tjado.passwdsafe.R.id.policy_view_generated_passwd);
    ...
    private void setTextStr(int id, int labelId, String str, boolean visible)
    {
        ...
        if (visible) {
            ...
            tv.setText((str != null) ? str : ctx.getString(
                    net2.tjado.passwdsafe.R.string.policy_no));
        } else {
    ...
    private String getPolicyOption(PasswdPolicy policy, int flag)
    {
        ...
        if (policy.checkFlags(flag)) {
            int strId = (policy.getType() == PasswdPolicy.Type.PRONOUNCEABLE)
                        ? net2.tjado.passwdsafe.R.string.yes : net2.tjado.passwdsafe.R.string.policy_yes_len;
            switch (flag) {
            ...
            case PasswdPolicy.FLAG_USE_SYMBOLS: {
                ...
                if (!TextUtils.isEmpty(symbols)) {
                    id = net2.tjado.passwdsafe.R.string.policy_yes_sym_policy;
                } else if (policy.checkFlags(
                               PasswdPolicy.FLAG_USE_EASY_VISION)) {
                    id = net2.tjado.passwdsafe.R.string.policy_yes_sym_easy;
                    symbols = PasswdPolicy.SYMBOLS_EASY;
                } else if (policy.checkFlags(
                               PasswdPolicy.FLAG_MAKE_PRONOUNCEABLE)) {
                    id = net2.tjado.passwdsafe.R.string.policy_yes_sym_pronounce;
                    symbols = PasswdPolicy.SYMBOLS_PRONOUNCE;
                } else {
                    id = net2.tjado.passwdsafe.R.string.policy_yes_sym_default;
