...
public abstract class DialogValidator
{
    ...
    {
        itsContext = ctx;
        itsErrorMsgView = (TextView)view.findViewById(net2.tjado.passwdsafe.R.id.error_msg);
        itsErrorFmt = view.getResources().getString(net2.tjado.passwdsafe.R.string.error_msg);
    }
