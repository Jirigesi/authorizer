...
public class PasswdFileData
{
    ...
    public final boolean removeRecord(PwsRecord rec, Context context)
    {
        ...
        do {
            if (itsPwsFile == null) {
                errMsg = net2.tjado.passwdsafe.R.string.record_not_found;
                break;
            }
            ...
            if (!passwdRec.getRefsToRecord().isEmpty()) {
                errMsg = net2.tjado.passwdsafe.R.string.record_has_references;
                break;
            }
        ...
        if (errMsg != 0) {
            String msg = context.getString(net2.tjado.passwdsafe.R.string.cannot_delete_record,
