...
public class PasswdHistory
{
    ...
    private static class HistoryAdapter extends ArrayAdapter<Entry>
    {
        ...
        public HistoryAdapter(ArrayList<Entry> entries,
                              ...
                              Context ctx)
        {
            super(ctx, net2.tjado.passwdsafe.R.layout.passwd_history_list_item, entries);
            itsIsEnabled = enabled;
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null) {
                convertView = itsInflater.inflate(
                        net2.tjado.passwdsafe.R.layout.passwd_history_list_item, parent, false);
        ...
        private static class ViewHolder implements View.OnClickListener
        {
                              ...
                              Context ctx)
            {
                itsPassword = (TextView)view.findViewById(
                        net2.tjado.passwdsafe.R.id.password);
                TypefaceUtils.setMonospace(itsPassword, ctx);
                itsDate = (TextView)view.findViewById(net2.tjado.passwdsafe.R.id.date);

                view.setEnabled(enabled);
                itsPassword.setEnabled(enabled);
                itsDate.setEnabled(enabled);

                View menuBtn = view.findViewById(net2.tjado.passwdsafe.R.id.item_menu);
                if (hasContextMenu) {
