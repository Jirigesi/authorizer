...
public class PasswdHistory
{
    ...
    private static class HistoryAdapter extends ArrayAdapter<Entry>
    {
        ...
        public HistoryAdapter(ArrayList<Entry> entries,
                              ...
                              Context ctx)
        {
            super(ctx, uci.tjado.passwdsafe.R.layout.passwd_history_list_item, entries);
            itsIsEnabled = enabled;
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null) {
                convertView = itsInflater.inflate(
                        uci.tjado.passwdsafe.R.layout.passwd_history_list_item, parent, false);
        ...
        private static class ViewHolder implements View.OnClickListener
        {
                              ...
                              Context ctx)
            {
                itsPassword = (TextView)view.findViewById(
                        uci.tjado.passwdsafe.R.id.password);
                TypefaceUtils.setMonospace(itsPassword, ctx);
                itsDate = (TextView)view.findViewById(uci.tjado.passwdsafe.R.id.date);

                view.setEnabled(enabled);
                itsPassword.setEnabled(enabled);
                itsDate.setEnabled(enabled);

                View menuBtn = view.findViewById(uci.tjado.passwdsafe.R.id.item_menu);
                if (hasContextMenu) {
