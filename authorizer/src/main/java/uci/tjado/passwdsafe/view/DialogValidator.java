...
public abstract class DialogValidator
{
    ...
    {
        itsContext = ctx;
        itsErrorMsgView = (TextView)view.findViewById(uci.tjado.passwdsafe.R.id.error_msg);
        itsErrorFmt = view.getResources().getString(uci.tjado.passwdsafe.R.string.error_msg);
    }
