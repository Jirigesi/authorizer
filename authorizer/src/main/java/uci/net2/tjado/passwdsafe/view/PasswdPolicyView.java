    ...
    implements OnCreateContextMenuListener, OnMenuItemClickListener
{
    ...
    {
        View row = findViewById(uci.net2.tjado.passwdsafe.R.id.policy_view_location_row);
        row.setVisibility((location == null) ? View.GONE : View.VISIBLE);

        if (location != null) {
            TextView tv = (TextView)findViewById(uci.net2.tjado.passwdsafe.R.id.policy_view_location);
            tv.setText(location);
        }
    }
    ...
    public void showPolicy(PasswdPolicy policy, int useCount)
    {
        ...
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_length, uci.net2.tjado.passwdsafe.R.id.policy_view_length_label,
                   Integer.toString(length), true);
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_type, uci.net2.tjado.passwdsafe.R.id.policy_view_type_label,
                   PasswdPolicy.getTypeStr(type, getContext()), true);
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_lowercase, uci.net2.tjado.passwdsafe.R.id.policy_view_lowercase_label,
                   lowercase, optionsVisible);
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_uppercase, uci.net2.tjado.passwdsafe.R.id.policy_view_uppercase_label,
                   uppercase, optionsVisible);
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_digits, uci.net2.tjado.passwdsafe.R.id.policy_view_digits_label,
                   digits, optionsVisible);
        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_symbols, uci.net2.tjado.passwdsafe.R.id.policy_view_symbols_label,
                   symbols, optionsVisible);

        setTextStr(uci.net2.tjado.passwdsafe.R.id.policy_view_use_count, uci.net2.tjado.passwdsafe.R.id.policy_view_use_count_label,
    ...
    {
        View row = findViewById(uci.net2.tjado.passwdsafe.R.id.policy_view_generate_row);
                                    ...
                                    ContextMenuInfo menuInfo)
    {
        if (v == itsGeneratedPasswd) {
            menu.setHeaderTitle(uci.net2.tjado.passwdsafe.R.string.password);
            menu.add(0, MENU_COPY, 0, uci.net2.tjado.passwdsafe.R.string.copy_clipboard).
    ...
    {
        inflate(context, uci.net2.tjado.passwdsafe.R.layout.passwd_policy_view, this);
        if (isInEditMode()) {
            return;
        }
        ...
        Button btn = (Button)findViewById(uci.net2.tjado.passwdsafe.R.id.policy_view_generate);
        ...
        itsGeneratedPasswd =
            (TextView)findViewById(uci.net2.tjado.passwdsafe.R.id.policy_view_generated_passwd);
    ...
    private void setTextStr(int id, int labelId, String str, boolean visible)
    {
        ...
        if (visible) {
            ...
            tv.setText((str != null) ? str : ctx.getString(
                    uci.net2.tjado.passwdsafe.R.string.policy_no));
        } else {
    ...
    private String getPolicyOption(PasswdPolicy policy, int flag)
    {
        ...
        if (policy.checkFlags(flag)) {
            int strId = (policy.getType() == PasswdPolicy.Type.PRONOUNCEABLE)
                        ? uci.net2.tjado.passwdsafe.R.string.yes : uci.net2.tjado.passwdsafe.R.string.policy_yes_len;
            switch (flag) {
            ...
            case PasswdPolicy.FLAG_USE_SYMBOLS: {
                ...
                if (!TextUtils.isEmpty(symbols)) {
                    id = uci.net2.tjado.passwdsafe.R.string.policy_yes_sym_policy;
                } else if (policy.checkFlags(
                               PasswdPolicy.FLAG_USE_EASY_VISION)) {
                    id = uci.net2.tjado.passwdsafe.R.string.policy_yes_sym_easy;
                    symbols = PasswdPolicy.SYMBOLS_EASY;
                } else if (policy.checkFlags(
                               PasswdPolicy.FLAG_MAKE_PRONOUNCEABLE)) {
                    id = uci.net2.tjado.passwdsafe.R.string.policy_yes_sym_pronounce;
                    symbols = PasswdPolicy.SYMBOLS_PRONOUNCE;
                } else {
                    id = uci.net2.tjado.passwdsafe.R.string.policy_yes_sym_default;
