 ...
 */
package uci.net2.tjado.passwdsafe;
...
import uci.net2.tjado.passwdsafe.file.HeaderPasswdPolicies;
import uci.net2.tjado.passwdsafe.file.PasswdExpiration;
import uci.net2.tjado.passwdsafe.file.PasswdFileData;
import uci.net2.tjado.passwdsafe.file.PasswdHistory;
import uci.net2.tjado.passwdsafe.file.PasswdPolicy;
import uci.net2.tjado.passwdsafe.file.PasswdRecord;
import uci.net2.tjado.passwdsafe.lib.PasswdSafeUtil;
import uci.net2.tjado.passwdsafe.lib.Utils;
import uci.net2.tjado.passwdsafe.lib.view.AbstractTextWatcher;
...
import uci.net2.tjado.passwdsafe.view.DatePickerDialogFragment;
import uci.net2.tjado.passwdsafe.view.NewGroupDialog;
import uci.net2.tjado.passwdsafe.view.PasswdLocation;
import uci.net2.tjado.passwdsafe.view.PasswdPolicyEditDialog;
import uci.net2.tjado.passwdsafe.view.PasswdPolicyView;
import uci.net2.tjado.passwdsafe.view.PasswordVisibilityMenuHandler;
import uci.net2.tjado.passwdsafe.view.TextInputUtils;
import uci.net2.tjado.passwdsafe.view.TimePickerDialogFragment;
                   ...
                   AdapterView.OnItemSelectedListener
{
    ...
    private static final String LauncherRecordShortcuts = "com.jiri.launcherrecordshortcutsdynamicfeature.LauncherRecordShortcuts";
    /**
    ...
    public void onClick(View v)
    {
        ...
        case R.id.link_ref: {
            ...
            intent.setClassName(getContext(),LauncherRecordShortcuts);
            ...
            case ALIAS: {
                intent.putExtra("filterNoShortcut",
                                true);
                break;
            }
            case SHORTCUT: {
