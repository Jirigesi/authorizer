...
public abstract class DialogValidator
{
    ...
    {
        itsContext = ctx;
        itsErrorMsgView = (TextView)view.findViewById(uci.net2.tjado.passwdsafe.R.id.error_msg);
        itsErrorFmt = view.getResources().getString(uci.net2.tjado.passwdsafe.R.string.error_msg);
    }
