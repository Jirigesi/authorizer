...
import uci.net2.tjado.passwdsafe.FileListFragment;
import uci.net2.tjado.passwdsafe.PasswdSafeApp;
import uci.net2.tjado.passwdsafe.Preferences;
import uci.net2.tjado.passwdsafe.StorageFileListFragment;
                   ...
                   StorageFileListFragment.Listener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(uci.net2.tjado.passwdsafe.R.layout.activity_launcher_file_shortcuts);
        ...
        if (itsIsDefaultFile) {
            setTitle(uci.net2.tjado.passwdsafe.R.string.default_file_to_open);
        } else {
            setTitle(uci.net2.tjado.passwdsafe.R.string.shortcut_file);
        }
    }
    ...
    public void onBackPressed()
    {
        ...
        Fragment frag = mgr.findFragmentById(uci.net2.tjado.passwdsafe.R.id.files);
    ...
    private void setFileChooseFrag()
    {
        ...
        if ((itsIsStorageFrag == null) || (itsIsStorageFrag != storageFrag)) {
            ...
            FragmentManager fragMgr = getSupportFragmentManager();
            FragmentTransaction txn = fragMgr.beginTransaction();
            txn.replace(uci.net2.tjado.passwdsafe.R.id.files, frag);
            txn.commit();
